...
func newCategory(db *gorm.DB) category {
	...
	_category.CategoryID = field.NewInt64(tableName, "CategoryID")
	_category.CategoryName = field.NewString(tableName, "CategoryName")
	_category.ParentCategoryID = field.NewInt64(tableName, "ParentCategoryID")
...
type category struct {
	...
	ALL              field.Asterisk
	CategoryID       field.Int64  // 商品类别唯一标识符
	CategoryName     field.String // 商品类别的名称
	ParentCategoryID field.Int64  // 商品类别的父类别，用于建立类别的层次结构，可为空
...
func (c *category) updateTableName(table string) *category {
	...
	c.CategoryID = field.NewInt64(table, "CategoryID")
	c.CategoryName = field.NewString(table, "CategoryName")
	c.ParentCategoryID = field.NewInt64(table, "ParentCategoryID")
...
func (c *category) fillFieldMap() {
	...
	c.fieldMap["CategoryName"] = c.CategoryName
	c.fieldMap["ParentCategoryID"] = c.ParentCategoryID
}
