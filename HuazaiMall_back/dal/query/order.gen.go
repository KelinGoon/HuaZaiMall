...
func newOrder(db *gorm.DB) order {
	...
	_order.OrderID = field.NewInt64(tableName, "OrderID")
	...
	_order.ShippingAddress = field.NewString(tableName, "ShippingAddress")
...
type order struct {
	...
	ALL             field.Asterisk
	OrderID         field.Int64   // 订单唯一标识符
	UserID          field.Int64   // 下订单的用户ID，外键指向用户表
	OrderDate       field.Time    // 订单创建日期，默认为当前时间戳
	OrderStatus     field.String  // 订单状态，可以是 "未支付"、"已支付"、"已发货"、"已完成" 或 "已取消"
	TotalAmount     field.Float64 // 订单的总金额
	ShippingAddress field.String  // 订单的配送地址
...
func (o *order) updateTableName(table string) *order {
	...
	o.ShippingAddress = field.NewString(table, "ShippingAddress")
...
func (o *order) fillFieldMap() {
	...
	o.fieldMap["ShippingAddress"] = o.ShippingAddress
}
