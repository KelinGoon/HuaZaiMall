...
func newProduct(db *gorm.DB) product {
	...
	_product.ProductID = field.NewInt64(tableName, "ProductID")
	_product.ProductName = field.NewString(tableName, "ProductName")
	_product.ProductDescription = field.NewString(tableName, "ProductDescription")
	_product.ProductPrice = field.NewFloat64(tableName, "ProductPrice")
	_product.ProductImageURL = field.NewString(tableName, "ProductImageURL")
	_product.ProductStock = field.NewInt64(tableName, "ProductStock")
	_product.CreationDate = field.NewTime(tableName, "CreationDate")
	_product.UpdateDate = field.NewTime(tableName, "UpdateDate")
	_product.CategoryID = field.NewInt64(tableName, "CategoryID")
	_product.SellerID = field.NewInt64(tableName, "SellerID")
...
type product struct {
	...
	ALL                field.Asterisk
	ProductID          field.Int64   // 商品唯一标识符
	ProductName        field.String  // 商品名称
	ProductDescription field.String  // 商品描述
	ProductPrice       field.Float64 // 商品价格，以十进制表示
	ProductImageURL    field.String  // 商品图片的 URL
	ProductStock       field.Int64   // 商品库存数量
	CreationDate       field.Time    // 商品创建日期，默认为当前时间戳
	UpdateDate         field.Time    // 商品最后更新日期
	CategoryID         field.Int64   // 商品所属类别的外键
	SellerID           field.Int64   // 商品的卖家用户ID，外键指向用户表
...
func (p *product) updateTableName(table string) *product {
	...
	p.ProductID = field.NewInt64(table, "ProductID")
	p.ProductName = field.NewString(table, "ProductName")
	p.ProductDescription = field.NewString(table, "ProductDescription")
	p.ProductPrice = field.NewFloat64(table, "ProductPrice")
	p.ProductImageURL = field.NewString(table, "ProductImageURL")
	p.ProductStock = field.NewInt64(table, "ProductStock")
	p.CreationDate = field.NewTime(table, "CreationDate")
	p.UpdateDate = field.NewTime(table, "UpdateDate")
	p.CategoryID = field.NewInt64(table, "CategoryID")
	p.SellerID = field.NewInt64(table, "SellerID")
...
func (p *product) fillFieldMap() {
	...
	p.fieldMap["ProductName"] = p.ProductName
	p.fieldMap["ProductDescription"] = p.ProductDescription
	p.fieldMap["ProductPrice"] = p.ProductPrice
	p.fieldMap["ProductImageURL"] = p.ProductImageURL
	p.fieldMap["ProductStock"] = p.ProductStock
	p.fieldMap["CreationDate"] = p.CreationDate
	p.fieldMap["UpdateDate"] = p.UpdateDate
	p.fieldMap["CategoryID"] = p.CategoryID
	p.fieldMap["SellerID"] = p.SellerID
}
